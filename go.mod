...
require (
	...
	github.com/openshift/machine-api-operator v0.2.1-0.20231121184208-ada49bdd94d9
	...
	sigs.k8s.io/controller-runtime/tools/setup-envtest v0.0.0-20231027153510-658c55227830
...
require (
	...
	golang.org/x/net v0.33.0 // indirect; Fixes CVE-2024-45338
