...
require (
	...
	github.com/openshift/machine-api-operator v0.2.1-0.20220930152820-30825f121cc5
...
replace github.com/openshift/api => github.com/nutanix-cloud-native/openshift-api v0.0.0-20230207165630-17ffc12900d6
